...
export const createSectionRule = [
    ...
    body("level").notEmpty().withMessage("Department Name Cannot Be Null!")
...
export const updateSectionRule = [
    body("id").notEmpty().withMessage("SectionId Cannot Be Null!")
...
export const inActiveSectionRule = [
    param("sectionId").notEmpty().withMessage("SectionId Cannot Be Null!")
        .isUUID("4").withMessage("Invalid DepartmentId")
];