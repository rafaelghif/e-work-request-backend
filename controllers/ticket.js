            ...
            sheets.map(async (sheet) => {
                ...
                for (const cols of rows) {
                    ...
                    if (cols["Description Of Problem"]) {
                        ...
                        const receivedDate = cols["Received"] ? formatDate(cols["Received"], cols, ticketType) : null;
                        const completedDate = cols["Completed"] ? formatDate(cols["Completed"], cols, ticketType) : null;
                    ...
                    if (cols["__EMPTY_2"]) {
                        ...
                        if (cols["__EMPTY"] === "No." || cols["__EMPTY_1"] === "Location" || cols["__EMPTY_2"] === "Description Of Problem") {
                            continue;
                        }
                        ...
                        const receivedDate = cols["__EMPTY_3"] ? formatDate(cols["__EMPTY_3"], cols, ticketType) : null;
